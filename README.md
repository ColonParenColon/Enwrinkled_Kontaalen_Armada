...
Reyden:  
-Midrange anti-medium strafing unit. Flanks then fires medium-heat lasers.
...
\-Now a Homeworld Salvage Corvette. Powerful, close-range capture beams. Only problem is it still is only built from the refinery.
...
Untresnafol:  
-Fires Point-Shadow nukes. Massive blast radius, with no piercing or heat. Good for clearing waves of lights/mediums and unarmoured heavies. Ineffective on heavies/capitals.
